$(document).ready(function () {
    ...
    $.ajax({
        ...
        url: 'https://localhost:44320/Subjects/Index',
        headers: {
    ...
    $.ajax({
        ...
        accepts: 'application/json',
        contentType: 'application/json',
        url: 'https://localhost:44320/Clazzs/Details',
        headers: {
            "Authorization": Cookies.get("token"),
        },
    ...
    $.ajax({
        ...
        accepts: 'application/json',
        contentType: 'application/json',
        url: 'https://localhost:44320/Accounts/Index',
        headers: {
            "Authorization": Cookies.get("token"),
        },
        success: function (result) {
    ...
    $(".btn-save-subject").click(function () {
        ...
        $.ajax({
            ...
            accepts: 'application/json',
            contentType: 'application/json',
            url: 'https://localhost:44320/Clazzs/AddSubjects',
            headers: {
                "Authorization": Cookies.get("token"),
    ...
    $(".btn-save-student").click(function () {
        ...
        $.ajax({
            ...
            accepts: 'application/json',
            contentType: 'application/json',
            url: 'https://localhost:44320/Clazzs/AddStudents',
            headers: {
                "Authorization": Cookies.get("token"),
                "Role": Cookies.get("loggedUserRole"),
            },
    ...
    $(".btn-submit-grade").on('click', function () {
        ...
        $.ajax({
            ...
            url: 'https://localhost:44320//Accounts/AddGrades',
            data: grades,
            success: function (result) {
                swal("Successful");
            },
